...
def register():
    ...
    return render_template('register.html', title='Register', form=form, SECRET_KEY = os.environ['SECRET_KEY'], SECRET_KEY = os.environ['SECRET_KEY'], WTF_CSRF_SECRET_KEY = os.environ['WTF_CSRF_SECRET_KEY'] )
